...
import io.github.up2jakarta.xml.FailFastHandler;
...
public class HandlerTest {
    ...
    private static final class SchemaCollector extends io.github.up2jakarta.xml.SchemaCollector {
        ...
        @Override
        public void handle(SeverityType level, SAXParseException cause) {
            super.handle(level, cause);
        }
    }
