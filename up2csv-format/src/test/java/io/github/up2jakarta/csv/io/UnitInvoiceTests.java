...
public class UnitInvoiceTests extends AUnitTests<MyRecord, UnitImporter<GroupType, SegmentType, Invoice, MyRecord, MyError>> {
    ...
    @Override
    protected UnitFileWriter<Invoice> writer(UnitImporter<GroupType, SegmentType, Invoice, MyRecord, MyError> importer, CSVFormat format) throws BeanException {
    ...
    protected UnitFileReader<Invoice, GroupType, SegmentType, MyRecord, MyError> reader(
            UnitImporter<GroupType, SegmentType, Invoice, MyRecord, MyError> importer, CSVFormat format
    ) {
