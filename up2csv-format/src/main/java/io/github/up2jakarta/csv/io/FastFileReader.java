 ...
 */
public abstract class FastFileReader<T extends Segment, B extends DataType<B>, I extends IType<B, I>, R extends IFastRecord<I, ?>, E extends IEvent<B>> extends BaseFileReader<T, B, I, R, E> {
