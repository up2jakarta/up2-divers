 ...
 */
public abstract class UnitFileReader<T extends Segment, B extends ITerm<B>, I extends Enum<I> & IType<I>, R extends IRecord<I>, E extends IEvent<B>> extends AbstractReader<T, B, I, R, E> {
