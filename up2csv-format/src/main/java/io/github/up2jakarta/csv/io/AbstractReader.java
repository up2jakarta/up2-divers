 ...
 */
public abstract class AbstractReader<T extends Segment, B extends ITerm<B>, I extends Enum<I> & IType<I>, R extends IRecord<I>, E extends IEvent<B>> extends BusinessReader<B, I, T, R, E> implements Closeable {
     ...
     * @throws IOException if the file does not exist or for some other reason cannot be opened for reading.
     */
    public final void open(final Reader reader) throws IOException {
    ...
    protected final R record() {
        ...
        trim(record.values(), nullValues);
        return this.transform(record);
    }

    abstract R transform(CSVRecord source);
