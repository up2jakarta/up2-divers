...
public class BeanContext {
    ...
    public static final BeanContext DISABLED = new BeanContext(false);
    public static final BeanContext DEFAULT = new BeanContext(true);

    private final boolean enabled;
    private final Class<?>[] groups;

    private BeanContext(boolean enabled, Class<?>... groups) {
     ...
     */
    public static BeanContext from(Class<? extends Segment> type) throws BeanException {
        while (type != Segment.class && Segment.class.isAssignableFrom(type)) {
            ...
            if (override != null) {
                ...
                return new BeanContext(true, override.groups());
            }
    ...
    public BeanContext build(Field field, ValidOverride override) throws BeanException {
