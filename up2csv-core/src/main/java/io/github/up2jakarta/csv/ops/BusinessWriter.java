...
/**
 * Base business writer implementation for multi-segments format that's able to write business-objects.
 *
 * @param <T> the business object type
 */
public abstract class BusinessWriter<T extends BusinessObject> implements Closeable, Flushable {

    final BusinessProcessor<?, ?, T> processor;

    BusinessWriter(BusinessProcessor<?, ?, T> processor) {
