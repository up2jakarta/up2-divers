 ...
 */
public abstract non-sealed class FullImporter<B extends DataType<B>, I extends IType<B, I>, T extends Referencable, R extends IFullRecord<I>, E extends IEvent<B>> extends BusinessImporter<B, I, T, R, E> {
