...
/**
 * Up2J Business Annotation that indicates the reference identifier property in order match parent-child relationship.
 * <p>
 * Note that it's supported on {@link io.github.up2jakarta.csv.cfg.Position} properties only.
 * <p>
 ...
 *            // ... other properties
 *
 *            @BusinessLink(value = "20", bean = @Linker(ItemAttributeLinker.class))
...
public @interface ReferenceId {
    ...
    /**
     * @return the code of the referenced segment input type.
