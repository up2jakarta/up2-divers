 ...
 *
 * @see io.github.up2jakarta.csv.annotation.Checker
 * @see io.github.up2jakarta.csv.annotation.Extension
 */
public interface CheckerContext {
    ...
    /**
     * Listener callback before scanning a field annotated by {@link io.github.up2jakarta.csv.annotation.Position}.
     *
     * @param property     the field annotated by {@link io.github.up2jakarta.csv.annotation.Position}
    ...
    /**
     * Listener callback after scanning a field annotated by {@link io.github.up2jakarta.csv.annotation.Position}.
     *
     * @param property     the field annotated by {@link io.github.up2jakarta.csv.annotation.Position}
     * @param propertyType the property type
     * @param offset       the position index
    ...
    /**
     * Listener callback before scanning a segment annotated by {@link io.github.up2jakarta.csv.annotation.Fragment}.
     * Before super-class segment handler or listener.
     *
     * @param fragment     the field annotated by {@link io.github.up2jakarta.csv.annotation.Fragment}
    ...
    /**
     * Listener callback after scanning a segment annotated by {@link io.github.up2jakarta.csv.annotation.Fragment}.
     *
     * @param fragment     the field annotated by {@link io.github.up2jakarta.csv.annotation.Fragment}
     * @param fragmentType the fragment type
     * @throws BeanException for any missing or wrong bean configuration
