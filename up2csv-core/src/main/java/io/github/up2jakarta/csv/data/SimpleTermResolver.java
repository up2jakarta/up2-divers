 ...
 */
public final class SimpleTermResolver<A extends Annotation, D extends ITerm<D>> extends TermResolver<D> {

    private final Class<A> annotationType;
    private final Function<A, D> adapter;

    public SimpleTermResolver(Class<D> type, Class<A> annotationType, Function<A, D> adapter) {
        super(type);
