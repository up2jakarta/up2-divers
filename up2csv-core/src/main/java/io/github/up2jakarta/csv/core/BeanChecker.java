...
final class BeanChecker implements CheckerContext {

    private final SegmentListener[] listeners;
    private final CheckerContext[] contexts;

    private BeanChecker(SegmentListener[] listeners, CheckerContext[] contexts) {
        this.listeners = listeners;
        this.contexts = contexts;
    }

    static BeanChecker of(Class<? extends Segment> type, BeanContext context) throws BeanException {
        ...
        return new BeanChecker(listeners, contexts);
    }
