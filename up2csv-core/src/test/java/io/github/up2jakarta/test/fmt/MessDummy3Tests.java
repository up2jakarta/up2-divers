...
class MessDummy3Tests extends AMessTest<Dummy3Invoice, TURecord, TUError> {

    @Autowired
    MessDummy3Tests(Up2Factory<TermType> factory) throws BeanException {
        super(factory.builder().mess(Dummy3Invoice.class).build(SegmentType.class).build(TUError::new, MAX_LEVEL));
    }
    ...
    void testCardinality4() throws BeanException {
        ...
        // When & Then
        checkCardinality4(S31, rows, importer.toExporter());
    }
    ...
    void testValid1() throws BeanException {
        // Given
        final TURecord[] rows = messInvoice(S31);
        // When & Then
        checkValid1(rows);
    }
