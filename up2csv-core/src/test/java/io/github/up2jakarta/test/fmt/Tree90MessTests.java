...
import io.github.up2jakarta.csv.data.SimpleMessExporter;
...
import io.github.up2jakarta.test.fmt.misc.AMessTester;
...
class Tree90MessTests {

    private final SimpleMessImporter<Tree90, TermType, SegmentType> importer;
    private final SimpleMessExporter<Tree90, TermType, SegmentType> exporter;

    @Autowired
    Tree90MessTests(Up2Factory<TermType> factory) throws BeanException {
        this.importer = new SimpleMessImporter<>(factory, Tree90.class, SegmentType.class);
    ...
    void testLevel0() {
        ...
        // When Formating
        final AMessTester<MessRecord<SegmentType>> tc = new AMessTester<>(root, records);
    ...
    void testFastDetached() {
        // Given
        final MessRecord<SegmentType> detached = record("92", "00");
        final MessRecord<SegmentType>[] records = new MessRecord[]{
                record("90", "00", "$"),
                record("91", "00", "10", "$.10"),
                detached
    ...
    void testDetached2() {
        // Given
        final MessRecord<SegmentType> detached = record("92", "00", "11", "21", "$.10.20");
        final MessRecord<SegmentType>[] records = new MessRecord[]{
                record("90", "00", "$"),
                record("91", "00", "10", "$.10"),
                record("92", "00", "10", "20", "$.10.20"),
    ...
    @Test
    void testDetached3() {
        final MessRecord<SegmentType> detached1 = record("93", "00", "11", "20", "31", "$.11.20.31");
        final MessRecord<SegmentType> detached2 = record("93", "00", "10", "21", "31", "$.10.21.31");
    ...
    void testDetached4() {
        // Given
        final MessRecord<SegmentType> detached1 = record("94", "00", "11", "20", "30", "41", "$.11.20.30.41");
        final MessRecord<SegmentType> detached2 = record("94", "00", "10", "21", "30", "41", "$.10.21.30.41");
        final MessRecord<SegmentType> detached3 = record("94", "00", "10", "20", "31", "41", "$.10.20.31.41");
        final List<Object> failures = new ArrayList<>(2);
        {
            failures.add(detached1);
            failures.add(detached2);
    ...
    void testPIdValidation() {
        // Given
        final MessRecord<SegmentType> detached = record("92", "00", "\t", "20", "$.10.20");
        final MessRecord<SegmentType>[] records = new MessRecord[]{
                record("90", "00", "$"),
                record("91", "00", "10", "$.10"),
                detached
