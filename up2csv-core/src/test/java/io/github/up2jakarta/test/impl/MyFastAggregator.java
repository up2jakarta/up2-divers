...
public class MyFastAggregator extends FastImporter<TermType, SegmentType, Invoice, InputRecord, InputError> {

    public MyFastAggregator(Up2Factory<TermType> factory) throws BeanException {
