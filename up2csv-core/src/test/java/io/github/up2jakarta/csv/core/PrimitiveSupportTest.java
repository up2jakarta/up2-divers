...
public class PrimitiveSupportTest {
    ...
    @Autowired
    PrimitiveSupportTest(MapperFactory<GroupType> f) {
        this.factory = f;
    }
    ...
    void testDefaultValues() throws BeanException {
        // Given
        final Mapper<Test2Primitive, GroupType> mapper = factory.build(Test2Primitive.class);
        // When
    ...
    void testMapDefault() throws BeanException {
        // Given
        final Mapper<Test1Primitive, GroupType> mapper = factory.build(Test1Primitive.class);
        // When
    ...
    void testUnmapDecimal() throws BeanException {
        // Given
        final Mapper<Test3Primitive, GroupType> mapper = factory.build(Test3Primitive.class);
