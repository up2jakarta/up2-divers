...
import io.github.up2jakarta.csv.ops.misc.AFullTest;
...
class FullInvoiceTests extends AFullTest<Invoice, InputRowEntity, InputErrorEntity> {

    @Autowired
    FullInvoiceTests(MapperFactory<GroupType> factory, SimpleCreator creator) throws BeanException {
        super(factory.builder().full(Invoice.class).full(S01).build(creator, (r) -> 0));
    }
