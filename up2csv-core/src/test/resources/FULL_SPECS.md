# Specification of Invoice `FULL` Format
...
| Name    | #Record | #Segment | Invoice id | Issue date | Gross amount | Net amount | Tax amount |
| Default |         |          |            |            |              |            |            |
...
| Name    | #Record | #Segment | Invoice id | Name | Country | City | ZIP code | Address 1st line | Address 2nd line |
| Default |         |          |            |      | TN      |      |          |                  |                  |
...
|---------|---------|----------|------------|-----|---------|
| Code    |         |          | I01        | A01 | A04     |
| Name    | #Record | #Segment | Invoice id | Key | Content |
| Default |         |          |            |     |         |
...
| Name    | #Record | #Segment | Invoice id | Item id | Product | Quantity | Gross amount | Net amount | Tax amount |
| Default |         |          |            |         |         | 1        |              |            |            |
...
| Name    | #Record | #Segment | Invoice id | Item id | Key | Value |
| Default |         |          |            |         |     |       |
...
| Name    | #Record | #Segment | Invoice id | Key | Value | Description |
| Default |         |          |            |     |       |             |
