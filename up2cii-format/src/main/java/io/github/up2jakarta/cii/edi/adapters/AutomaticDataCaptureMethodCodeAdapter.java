...
@Named
@Singleton
public class AutomaticDataCaptureMethodCodeAdapter extends CodeListAdapter<AutomaticDataCaptureMethodCodeType> {

    @Inject
    public AutomaticDataCaptureMethodCodeAdapter() {
