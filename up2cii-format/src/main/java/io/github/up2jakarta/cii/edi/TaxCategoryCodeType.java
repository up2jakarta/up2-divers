...
@Documented(value = "Duty or Tax or Fee Category Code", agency = Agency.UN_ECE, version = "D22B")
...
public enum TaxCategoryCodeType implements CodeList<TaxCategoryCodeType> {
     ...
     * supplied in the Canary Islands (Spain) by traders and professionals, as well as on
     * import of goods.
     */
    L("L", "Canary Islands general indirect tax"),

    /**
     * Impuesto sobre la Producción, los Servicios y la Importación (IPSI) is an indirect
     * municipal tax, levied on the production, processing and import of all kinds of movable
     * tangible property, the supply of services and the transfer of immovable property located
     * in the cities of Ceuta and Melilla.
     */
    M("M", "Tax for production, services and importation in Ceuta and Melilla"),

    /**
     * standard VAT calculated for an additional taxable base when the additional taxable
     * base is not included in the document totals
     */
