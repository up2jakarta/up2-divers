...
public class CIIMultipleExceptionTest {
    ...
    private static final List<String> PRINTED_LINES = Arrays.asList(
            ...
            "1) io.github.up2jakarta.cii.api.XValidationException: java.lang.NullPointerException: Cause",
            "Caused by: java.lang.NullPointerException: Cause",
            "2) io.github.up2jakarta.cii.api.XValidationException: java.lang.Exception: Another",
