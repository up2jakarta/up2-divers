...
public class FreightChargeTariffClassCodeTest extends CodeAdapterTest {

    private static final io.github.up2jakarta.cii.format.unmapped.qdt.FreightChargeTariffClassCodeType WRONG_CODE =
            new io.github.up2jakarta.cii.format.unmapped.qdt.FreightChargeTariffClassCodeType() {{
                setValue("???");
            }};

    public FreightChargeTariffClassCodeTest(@Autowired ApplicationContext context) throws IOException {
        super(context, "invalid_freight_charge_tariff_class.xml", (i) -> {
