...
public class TransportMovementStageCodeTypeCodeTest extends CodeAdapterTest {

    private static final io.github.up2jakarta.cii.format.unmapped.qdt.TransportMovementStageCodeType WRONG_CODE =
            new io.github.up2jakarta.cii.format.unmapped.qdt.TransportMovementStageCodeType() {{
                setValue("???");
            }};

    public TransportMovementStageCodeTypeCodeTest(@Autowired ApplicationContext context) throws IOException {
        super(context, "invalid_logistics_transport_movement.xml", (i) -> {
