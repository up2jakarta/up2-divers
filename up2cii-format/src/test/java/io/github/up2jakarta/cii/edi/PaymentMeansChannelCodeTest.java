...
public class PaymentMeansChannelCodeTest extends CodeAdapterTest {

    private static final io.github.up2jakarta.cii.format.unmapped.qdt.PaymentMeansChannelCodeType WRONG_CODE =
            new io.github.up2jakarta.cii.format.unmapped.qdt.PaymentMeansChannelCodeType() {{
                setValue("???");
            }};

    public PaymentMeansChannelCodeTest(@Autowired ApplicationContext context) throws IOException {
        super(context, "invalid_payment_means_channel.xml", (i) -> {
            ...
            payment.setPaymentChannelCode(WRONG_CODE);
        });
    }
    ...
    public void value() {
        ...
        final PaymentMeansChannelCodeType code = payment.getPaymentChannelCode();
        assertEquals(PaymentMeansChannelCodeType.V_5, code);
