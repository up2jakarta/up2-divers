...
public class AccountingAmountTypeCodeTest extends CodeAdapterTest {

    private static final io.github.up2jakarta.cii.format.unmapped.qdt.AccountingAmountTypeCodeType WRONG_CODE =
            new io.github.up2jakarta.cii.format.unmapped.qdt.AccountingAmountTypeCodeType() {{
                setValue("???");
            }};

    public AccountingAmountTypeCodeTest(@Autowired ApplicationContext context) throws IOException {
        super(context, "invalid_accounting_amount_type.xml", (i) -> {
            ...
            account.setAmountTypeCode(WRONG_CODE);
        });
    }
    ...
    public void value() {
        ...
        final AccountingAmountTypeCodeType code = account.getAmountTypeCode();
        assertEquals(AccountingAmountTypeCodeType.V_6, code);
    ...
    public void validate() throws IOException {
        ...
        assertEquals(1, errors.size());
        {
            ...
            assertEquals("EDI-E601: Unknown value [???] for CodeList[AccountingAmountTypeCodeType].", error.getMessage());
