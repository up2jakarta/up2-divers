...
public class GoodsTypeCodeTest extends CodeAdapterTest {

    private static final io.github.up2jakarta.cii.format.unmapped.qdt.GoodsTypeCodeType WRONG_CODE =
            new io.github.up2jakarta.cii.format.unmapped.qdt.GoodsTypeCodeType() {{
                setValue("???");
            }};

    public GoodsTypeCodeTest(@Autowired ApplicationContext context) throws IOException {
        super(context, "invalid_goods_type.xml", (i) -> {
    ...
    public void value() {
        ...
        assertNotNull(code);
        assertEquals(GoodsTypeCodeType.ZZZ, code);
    ...
    public void validate() throws IOException {
        ...
        assertEquals(1, errors.size());
        {
            ...
            assertEquals("ECE-7357: Unknown value [???] for CodeList[GoodsTypeCodeType].", error.getMessage());
