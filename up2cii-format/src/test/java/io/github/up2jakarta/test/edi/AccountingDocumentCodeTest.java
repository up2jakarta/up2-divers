...
public class AccountingDocumentCodeTest extends CodeAdapterTest {

    private static final io.github.up2jakarta.cii.format.unmapped.qdt.AccountingDocumentCodeType WRONG_CODE =
            new io.github.up2jakarta.cii.format.unmapped.qdt.AccountingDocumentCodeType() {{
                setValue("???");
            }};

    public AccountingDocumentCodeTest(@Autowired ApplicationContext context) throws IOException {
        super(context, "invalid_accounting_document.xml", i -> {
            ...
            account.setSetTriggerCode(WRONG_CODE);
        });
    }
    ...
    public void value() {
        ...
        final AccountingDocumentCodeType code = account.getSetTriggerCode();
        assertEquals(AccountingDocumentCodeType.V_220, code);
    ...
    public void validate() throws IOException {
        ...
        assertEquals(1, errors.size());
        {
            ...
            assertEquals(265, error.getLineNumber());
            assertEquals(65, error.getLineOffset());
            assertEquals("ECE-1001: Unknown input [???] for CodeList[AccountingDocumentCodeType].", error.getMessage());
