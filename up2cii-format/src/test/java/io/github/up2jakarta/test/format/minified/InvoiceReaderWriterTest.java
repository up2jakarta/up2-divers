...
public class InvoiceReaderWriterTest {
    ...
    private void testReadAndWriteInvoice(String xmlFile, boolean lenient) throws Exception {
        assertNotNull(xmlFile);
        util.assertInvoice(loadResource(xmlFile), validator, reader, writer, lenient);
    }
    ...
    @Test
    public void testValid1ForAdapters() {
        assertThrows(XMultipleException.class, () -> testReadAndWriteInvoice("xml/unece/valid1-formatCII.xml", false));
    }

    @Test
    public void testValid2ForAdapters() {
        assertThrows(XMultipleException.class, () -> testReadAndWriteInvoice("xml/unece/valid2-formatCII.xml", false));
    }

    @Test
    public void testValid3ForAdapters() {
        assertThrows(XMultipleException.class, () -> testReadAndWriteInvoice("xml/unece/valid3-formatCII.xml", false));
    }

    @Test
    public void testValid4ForAdapters() {
        assertThrows(XMultipleException.class, () -> testReadAndWriteInvoice("xml/unece/valid4-formatCII.xml", false));
    }

    @Test
    public void testLenientValid1ForAdapters() throws Exception {
        testReadAndWriteInvoice("xml/unece/valid1-formatCII.xml", true);
    }

    @Test
    public void testLenientValid2ForAdapters() throws Exception {
        testReadAndWriteInvoice("xml/unece/valid2-formatCII.xml", true);
    }

    @Test
    public void testLenientValid3ForAdapters() throws Exception {
        testReadAndWriteInvoice("xml/unece/valid3-formatCII.xml", true);
    }

    @Test
    public void testLenientValid4ForAdapters() throws Exception {
        testReadAndWriteInvoice("xml/unece/valid4-formatCII.xml", true);
    }
