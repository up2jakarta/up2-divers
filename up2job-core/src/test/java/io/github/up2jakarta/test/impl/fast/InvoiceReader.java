...
public class InvoiceReader extends FastFileReader<Invoice, TermType, SegmentType, InputRecord, InputError> implements ItemReader<Up2Result<Invoice, InputError>>, StepExecutionListener {
