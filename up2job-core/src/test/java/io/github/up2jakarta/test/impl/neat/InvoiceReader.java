...
public class InvoiceReader extends NeatFileReader<Invoice, TermType, SegmentType, InputRecord, InputError> implements ItemReader<Up2Result<Invoice, InputError>>, StepExecutionListener {
