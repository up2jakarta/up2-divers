...
import io.github.up2jakarta.test.impl.mess.InputError;
import io.github.up2jakarta.test.impl.mess.InvoiceImporter;
import io.github.up2jakarta.test.impl.mess.InvoiceReader;
import io.github.up2jakarta.test.impl.mess.InvoiceWriter;
...
class MessCopyJobITests extends AbstractJobITest {

    private final Job job;

    @Autowired
    MessCopyJobITests(ApplicationContext context, CSVFormat format) throws IOException, BeanException {
    ...
    private Job job(ApplicationContext context) throws BeanException {
        ...
        final ChunkOrientedStep<?, ?> step = new StepBuilder("copy", repository)
                ...
                .build();
        return new JobBuilder("MESS", repository)
                .start(step)
                .build();
    }
    ...
    void test() throws Exception {
        // GIVEN
        final JobParameters jps = this.input(200);
