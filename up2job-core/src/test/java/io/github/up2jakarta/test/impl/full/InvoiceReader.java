...
public class InvoiceReader extends FullFileReader<Invoice, TermType, SegmentType, InputRecord, InputError> implements ItemReader<Up2Result<Invoice, InputError>>, StepExecutionListener {
