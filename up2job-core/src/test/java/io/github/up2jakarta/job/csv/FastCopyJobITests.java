...
import io.github.up2jakarta.job.csv.impl.fast.InputError;
import io.github.up2jakarta.job.csv.impl.fast.InvoiceImporter;
import io.github.up2jakarta.job.csv.impl.fast.InvoiceReader;
import io.github.up2jakarta.job.csv.impl.fast.InvoiceWriter;
...
class FastCopyJobITests extends AbstractJobITest {

    private final Job job;

    @Autowired
    FastCopyJobITests(ApplicationContext context, CSVFormat format) throws IOException, BeanException {
